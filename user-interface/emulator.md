...
To configure VUEngine Studio to make use of any of your custom emulator configurations, you have so choose it as the new default emulator using the command:

    Emulator: Set Default Emulator Config...

Note that this command writes the name of your emulator config to a preference like so:

```json
[...]
```

So you have to reset it in case you change the name of your desired emulator configuration.